package com.pouruan.common.email;
...
import com.pouruan.common.email.EmailSendTool.Email_Autherticator;
...
public class EmailSendTool {
	...
	public boolean sendEmail(String host,String emailUserName,String emailPwd,String toEmail,String title,String content,String userName){
		EmailSendTool sendEmail = new EmailSendTool(host,
				emailUserName, emailPwd, toEmail,
	...
	public static void main(String[] args) {
		EmailSendTool sendEmail = new EmailSendTool("smtp.mxhichina.com",
				"postmaster@icecms.cn", "Jkl20081102", "742820157@qq.com",
				"测试", "文本内容", "我", "", "");
		try {
			sendEmail.send();
		} catch (Exception ex) {
